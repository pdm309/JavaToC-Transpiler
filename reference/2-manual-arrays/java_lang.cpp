...
namespace java {
  namespace lang {
    ...
    Class __ArrayOfInt::__class() {
      static Class k =
        new __Class(__rt::literal("[I"), __Object::__class());
      return k;
    }

    // The vtable for int[].  Note that this definition invokes the
    // default no-arg constructor for __ArrayOfInt_VT.
    __ArrayOfInt_VT __ArrayOfInt::__vtable;
  }
}
